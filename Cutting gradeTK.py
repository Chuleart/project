...
def on_click():
   ...
   if score>=80 and score<=100:
      ...
      total=Label(root, text="ได้เกรด 4")
      ...
      total=Label(root, text="ได้เกรด 3")
      total.grid(row=2, column=2, sticky=W)
      ...
      total=Label(root, text="ได้เกรด 2")
      total.grid(row=2, column=2, sticky=W)
      ...
      total=Label(root, text="ได้เกรด 1")
      total.grid(row=2, column=2, sticky=W)
      ...
      print("again Please")
      Entry(root, textvariable=score).pack(side=LEFT)
